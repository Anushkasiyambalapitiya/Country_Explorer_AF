...
const handleClick = ()=>{
  ...
  return (
    <footer className="bg-gradient-to-r from-blue-950 to-blue-900 text-white py-8 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border-t border-white/20 mt-6 pt-6 text-center text-sm">
          <p>© {new Date().getFullYear()} Rest Countries. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
